      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-3 gap-10">
        ...
        <div>
          <h4 className="text-white font-bold mb-5 text-xs uppercase tracking-widest flex items-center gap-2">
            <span className="w-4 h-px bg-[#1A3A8A] inline-block" /> Navegación
          </h4>
          <ul className="space-y-2 text-sm">
            {[
              ...
              <li key={href}>
                <Link href={href} className="hover:text-[#1A3A8A] transition-colors flex items-center gap-2 group">
                  <span className="w-0 group-hover:w-3 h-px bg-[#1A3A8A] transition-all duration-200 inline-block" />
                  {label}
                </Link>
              </li>
            ))}
        ...
        <div>
          <h4 className="text-white font-bold mb-5 text-xs uppercase tracking-widest flex items-center gap-2">
            <span className="w-4 h-px bg-[#1A3A8A] inline-block" /> Contacto
          </h4>
          <ul className="space-y-3 text-sm">
            <li>
              <a href="https://wa.me/593999427291" target="_blank" className="hover:text-[#1A3A8A] transition-colors flex items-center gap-2">
                <span className="text-[#1A3A8A]">WA</span> 0999427291
              </a>
            </li>
            <li>
              <a href="tel:042938828" className="hover:text-[#1A3A8A] transition-colors">
                042938828
              </a>
            </li>
            <li>
              <a href="mailto:gerencia@federicocedeno.com" className="hover:text-[#1A3A8A] transition-colors">
