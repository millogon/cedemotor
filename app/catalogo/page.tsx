      ...
      <section className="bg-[#0f0f0f] pt-36 pb-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-[#D4A017] text-xs font-bold uppercase tracking-widest">Todos los vehículos</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-white">
            Catálogo de <span className="text-[#D4A017]">Autos</span>
          </h1>
      ...
      <section className="py-16 bg-[#0f0f0f]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {autos.map((auto) => (
              <div key={auto.id} className={`border transition-all duration-200 group bg-[#111] ${auto.disponible ? "border-gray-800 hover:border-[#D4A017]" : "border-gray-900 opacity-60"}`}>
                {/* Imagen placeholder */}
                ...
                <div className="p-5">
                  ...
                  {auto.disponible && (
                    <a
                      ...
                      target="_blank"
                      className="w-full flex items-center justify-center gap-2 py-2.5 bg-[#D4A017] text-black text-sm font-bold uppercase tracking-widest hover:bg-[#c49010] transition-all"
                    >
